        ...
        <div class="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6">
          ...
          >
            <div class="px-4 py-8 sm:px-10">
              <div>
                <p class="text-sm font-medium text-secondary">Sign in with</p>

                <div>
                  <a
                    href="#"
                    class="w-full inline-flex justify-center py-2 px-4 border border-secondary-light rounded-md shadow-sm bg-white text-sm font-medium text-secondary hover:bg-secondary-light"
